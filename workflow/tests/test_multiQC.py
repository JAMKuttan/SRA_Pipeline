...
test_output_path = os.path.dirname(os.path.abspath(__file__)) + '/../output/Samples/QC/Raw/'
test_output_mc_path = os.path.dirname(os.path.abspath(__file__)) + '/../output/Samples/QC/Raw/SRADownload.MultiQC.Report_data'
